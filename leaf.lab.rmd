...
Thanks for your interest in the Leaf Lab. I am interested in recruiting strong Masters and Ph.D. candidates with an interest and enthusiasm for using quantitative methods for understanding the natural world. We are engaged in a range of fisheries and ecological research and a survey of the recent and current research projects conducted in the lab will give you a sense of our research foci. 

I generally accept students only when I have funding available, and advertise these available positions on the AFS job opportunities website. The Division of Coastal Sciences does offerCOA Graduate Fellowship Opportunities for exceptional students.
...
+ Faculty at USM’s Div. of Coastal Sciences will generally not admit students to the program without arranging sponsorship by an advisor – applying to the Div. of Coastal Sciences without talking with an advisor and also understanding the availability of funding is a waste of your valuable time and energy.
...
+ CV –include your GRE scores (unofficial are fine but percentile scores must be included for each) and contact info
+ Legible copies of transcripts (Unofficial or Official).
